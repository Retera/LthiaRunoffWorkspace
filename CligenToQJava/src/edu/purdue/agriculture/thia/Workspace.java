...
public final class Workspace {
	...
	/**
	 * Returns the path to a file within the input directory, given a file name
	 * or relative path within that input directory
	 *
	 * @param name
	 *            The relative path to a file in the input directory
	 * @return
	 */
	...
	/**
	 * Returns the path to a file within the output directory, given a file name
	 * or relative path within that output directory
	 *
	 * @param name
	 *            The relative path to a file in the output directory
	 * @return
	 */
